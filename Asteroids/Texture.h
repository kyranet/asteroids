...
class Texture {
 public:
  ...
  // render part of the texture (clip) to a destination rectangle with a
  // rotation, if no clip provided it renders all texture (scaled to dest). We
  // either provide a renderer or use the one used at construction
