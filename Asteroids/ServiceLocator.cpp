...
TexturesManager* ServiceLocator::getTextures() const { return textures_; }

AudioManager* ServiceLocator::getAudios() const { return audio_; }
...
FontsManager* ServiceLocator::getFonts() const { return fonts_; }
